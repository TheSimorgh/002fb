...
const deleteHandler = async () => {
  ...
  return (
    <ul className="post_menu" ref={menu}>
      ...
      {imagesLength && (<div onClick={() => downloadImages()}><MenuItem icon="download_icon" title="Download" /></div> )}
      ...
      {test && (<div onClick={() => deleteHandler()}><MenuItem icon="trash_icon"title="Move to trash" subtitle="items in your trash are deleted after 30 days"/></div>)}
